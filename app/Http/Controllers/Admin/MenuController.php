...
class MenuController extends Controller
{
    ...
    public function store(MenuRequest $request)
    {
		...
		if(!$this->getRepositories()->store($data,['form'=>['user'=>$this->user]])){
    ...
    {
		if(!$num=$this->getRepositories()->remove($request->id,['form'=>['user'=>$this->user]])){
    ...
    {
		$this->getRepositories()->detach(["id"=>$id,"access_id"=>$request->access_id],['form'=>['user'=>$this->user]]);
    ...
    {
		$this->getRepositories()->attach(["id"=>$id,"access_id"=>$request->access_id],['form'=>['user'=>$this->user]]);
